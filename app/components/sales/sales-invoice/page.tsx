    ...
    <div className="space-y-8">
      ...
      <div>
        <h2 className="text-xl font-bold text-slate-200 mb-5 flex items-center gap-2">
          <svg className="w-5.5 h-5.5 text-indigo-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            {loading ? (
              <div className="flex items-center justify-center py-3 dark:bg-slate-900/50 border border-slate-100 dark:border-slate-800 rounded-xl text-slate-400 text-sm animate-pulse">
      ...
      <div>
        ...
        <div className="overflow-hidden rounded-xl border border-slate-800 shadow-sm bg-slate-900">
              ...
              {items.length === 0 ? (
                <tr>
                  <td colSpan={6} className="py-16 px-5 text-center">
                    <div className="flex flex-col items-center justify-center max-w-sm mx-auto space-y-4">
                      ...
                      <div>
                        <h4 className="text-slate-200 font-bold text-base">Invoice is empty</h4>
                ...
                items.map((item, index) => (
                  <tr
                    ...
                    className="hover:bg-slate-800/40 transition-colors duration-150 text-slate-300"
                  >
                    <td className="py-4 px-5 text-center text-slate-500 font-mono text-xs">{index + 1}</td>
                    <td className="py-4 px-5 font-semibold text-white">{item.product_name}</td>
                    ...
                    <td className="py-4 px-5 text-center">
                      <button
                        type="button"
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 hover:bg-red-950/20 text-red-400 hover:text-red-300 rounded-lg text-xs font-bold transition-all"
      ...
      {/* Grand Total Section */}
      {items.length > 0 && (
        <div className="bg-gradient-to-r from-slate-900/60 to-indigo-950/20 rounded-2xl p-6 border border-indigo-950/30 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 shadow-sm">
          <div>
          ...
          <div className="text-right">
            ...
            <p className="text-3xl font-extrabold text-transparent bg-gradient-to-r from-indigo-400 to-sky-400 bg-clip-text">

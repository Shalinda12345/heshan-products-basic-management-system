...
export default function DailyExpenses(){
    const [monthlyExpenes, setMonethlyExpenses] = useState<Expense[]>([]);
    ...
    const totalExpense = monthlyExpenes.reduce((sum, s) => sum + Number(s.total), 0);

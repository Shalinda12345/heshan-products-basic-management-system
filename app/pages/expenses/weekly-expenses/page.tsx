...
export default function DailyExpenses(){
    const [weeklyExpenes, setWeeklyExpenses] = useState<Expense[]>([]);
    ...
    const totalExpense = weeklyExpenes.reduce((sum, s) => sum + Number(s.total), 0);
